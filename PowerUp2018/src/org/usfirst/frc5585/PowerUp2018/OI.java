...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Grab Lift", new GrabLift());
        SmartDashboard.putData("Grab Lift Release", new GrabLiftRelease());

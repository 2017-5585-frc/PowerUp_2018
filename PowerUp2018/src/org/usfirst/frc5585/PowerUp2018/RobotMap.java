...
public class RobotMap {
    ...
    public static DoubleSolenoid pnuematicsGrabGripper;
    public static DoubleSolenoid pnuematicsLiftLift;
    public static Compressor compressor1Comp;
    ...
    public static void init() {
        ...
        pnuematicsGrabGripper = new DoubleSolenoid(0, 3, 2);
        LiveWindow.addActuator("PnuematicsGrab", "Gripper", pnuematicsGrabGripper);
        
        pnuematicsLiftLift = new DoubleSolenoid(0, 0, 1);
        LiveWindow.addActuator("PnuematicsLift", "Lift", pnuematicsLiftLift);
        
        compressor1Comp = new Compressor(0);
        LiveWindow.addActuator("Compressor1", "Comp", compressor1Comp);
